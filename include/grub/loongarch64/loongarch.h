...
#define CSR_TLBIDX_PS_MASK (0x3f << CSR_TLBIDX_PS_SHIFT) // 0x111111 << 24
#define PS_DEFAULT_SIZE_PS 0xc // 4KB

#define PS_SET_MASK (CSR_TLBIDX_PS_MASK >> 16)
#define PS_DEFAULT_SET_VAL (PS_DEFAULT_SIZE_PS << (CSR_TLBIDX_PS_SHIFT - 16)) 
